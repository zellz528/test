...
CREATE TYPE regulatory_election AS ENUM (
    'AUSTRALIA', 
    'AUSTRIA',
    'BELGIUM',
    'CANADA',
...
CREATE TYPE industry_change_application_object_status AS ENUM ('CURRENT', 'DELETED');
CREATE TYPE industry_change_application_status AS ENUM ('IN_REVIEW', 'APPROVED','REJECTED');



CREATE TABLE Industry_change_application (
	id INTEGER default nextval('industry_change_application_id_seq') NOT NULL,
	resident_sub VARCHAR(250) NOT NULL,
	"current" JSON NOT NULL,
	requested JSON NOT NULL,
